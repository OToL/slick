...
// SLICK - BEGIN
void imguiBeginFrameEx(int32_t _mx, int32_t _my, uint8_t _button, int32_t _scroll_delts, uint16_t _width, uint16_t _height, int _inputChar = -1, bgfx::ViewId _view = 255);
// SLICK - END
