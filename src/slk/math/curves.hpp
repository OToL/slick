...
SB_DECLARE_TAG(CurveFeaturePoint);
SB_DECLARE_TAG(CurveFeatureSection);
...
BezierSplineInfo get_bezier_spline_info(CurveFeaturePointTag, u32 section_cnt);
BezierSplineInfo get_bezier_spline_info(CurveFeatureSectionTag, u32 ctrl_point_cnt);
