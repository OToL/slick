...
if(TARGET bgfx::shaderc)
	...
	function(_bgfx_shaderc_parse ARG_OUT)
        # [slk] Added DEPENDS to make the shader file dependent on inclusions
        # TODO(ebeau): can it be done at the shader compiler level i.e it would generate its dependencies (e.g. 2 passes)
		cmake_parse_arguments(
			ARG
	...
	function(bgfx_compile_shaders)
		...
		foreach(SHADER_FILE ${ARGS_SHADERS})
            ...
            # [slk] added ARGS_DEPENDS to DEPENDS to handle included files modifigictions
			add_custom_command(
				OUTPUT ${OUTPUTS}
