...
function(slk_add_executable target_name)
    ...
    if(${SLICK_TARGET_PLATFORM_ID} STREQUAL "ps3")
       target_link_options(${target_name} PUBLIC 
        ...
        add_custom_command(
            ...
            POST_BUILD
                ...
                COMMAND ${CMAKE_COMMAND} -E env ${SLICK_PS3_TOOL_STRIP} $<TARGET_FILE:${target_name}> -o $<TARGET_FILE:${target_name}>.stripped
                COMMAND ${CMAKE_COMMAND} -E env ${SLICK_PS3_TOOL_SPRXLINKER} $<TARGET_FILE:${target_name}>.stripped
                COMMAND ${CMAKE_COMMAND} -E env ${SLICK_PS3_TOOL_MAKESELF} $<TARGET_FILE:${target_name}>.stripped $<TARGET_FILE_DIR:${target_name}>/${target_name}.self
        )
    endif()
